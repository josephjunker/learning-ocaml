...
let initial_pieces_by_position =
  let white_pieces =
    add_piece_positions_to_map
      (Map.empty (module Position))
      white_initial_pieces White
  in
  add_piece_positions_to_map white_pieces black_initial_pieces Black

let initial_white_pieces =
  add_piece_to_set
    (Set.empty (module Piece_Position))
    white_initial_pieces White

let initial_black_pieces =
  add_piece_to_set
    (Set.empty (module Piece_Position))
    black_initial_pieces Black
